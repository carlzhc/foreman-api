...
(defapi
 ...
 "List attributes for a given storage domain"
 :GET
 "/api/compute_resources/%s/storage_domains/%s"
 id
 storage-domain-id)
...
(defapi
 ...
 "List storage domains for a compute resource"
 :GET
 "/api/compute_resources/%s/available_clusters/%s/available_storage_domains"
 id
 cluster-id)
...
(defapi
 ...
 "List attributes for a given storage pod"
 :GET
 "/api/compute_resources/%s/storage_pods/%s"
 id
 storage-pod-id)
...
(defapi
 ...
 "List storage pods for a compute resource"
 :GET
 "/api/compute_resources/%s/available_clusters/%s/available_storage_pods"
 id
 cluster-id)
...
(defapi
 list-all-of-revision-config_templates
 "List all of revision config_templates"
 :GET
...
(defapi
 list-all-of-revision-provisioning_templates
 "List all of revision provisioning_templates"
 :GET
...
(defapi
 list-all-of-revision-report_templates
 "List all of revision report_templates"
 :GET
...
(defapi
 ...
 "Schedule generating of a report"
 :POST
 "/api/report_templates/%s/schedule_report"
 id)
...
(defapi
 ...
 "Downloads a generated report"
 :GET
 "/api/report_templates/%s/report_data/%s"
 id
 job-id)
...
(defapi
 ...
 "List template combination"
 :GET
 "/api/config_templates/%s/template_combinations"
 config-template-id)
...
(defapi
 ...
 "Show template combination"
 :GET
 "/api/config_templates/%s/template_combinations/%s"
 config-template-id
 id)
